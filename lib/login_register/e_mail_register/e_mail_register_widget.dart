...
import 'e_mail_register_model.dart';
export 'e_mail_register_model.dart';

class EMailRegisterWidget extends StatefulWidget {
  const EMailRegisterWidget({super.key});

  static String routeName = 'E-mail_Register';
  static String routePath = '/eMailRegister';

  @override
  State<EMailRegisterWidget> createState() => _EMailRegisterWidgetState();
}
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              _model.namev = await actions
                                                  .validateFullName(
                                                _model.nameTextController.text,
                                              );
                                              _model.mailv = await actions
                                                  .validateUniversityEmail(
                                                _model.emailTextController.text,
                                              );
                                              if (_model.namev == true) {
                                                if (_model.mailv == true) {
                                                  GoRouter.of(context)
                                                      .prepareAuthEvent();
                                                  if (_model
                                                  ...
                                                  await ProfileTable().insert({
                                                    ...
                                                    'password': _model
                                                        .passwordTextController
                                                        .text,
                                                    'gender': _model.genValue,
                                                    'role':
                                                        _model.enterTypeValue,
                                                  });
                                                } else {
                                                  await showDialog(
                                                    context: context,
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text('خطا'),
                                                        content: Text(
                                                            'قم بكتابة ايميل خاص بجامعة بغداد'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
